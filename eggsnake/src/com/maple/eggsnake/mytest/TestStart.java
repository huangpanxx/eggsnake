...
public class TestStart extends AnimateImageListener implements ApplicationListener{
	
	StartMenuStage stage;
	...
	public void create() {
		...
		bgSound.play();
		stage = new StartMenuStage(Gdx.graphics.getWidth(), Gdx.graphics.getHeight(), true);
